...
<body class="navbar-primary">
  <div class="container-scroller">
    ...
    <div class="container-fluid page-body-wrapper">
      <div class="row " >
        <div class="content-wrapper full-page-wrapper d-flex align-items-center auth-pages div-1">
          <div class="card col-lg-3 mx-auto ">
            <div class="card-body px-6 py-6">
              <img style="width: 100%;" src="<?php echo base_url();?>resources/images/logos/ALDIDACOM.png" alt="">
        ...
        <footer class="footer_login">
          <div class="container-fluid clearfix">
            <span class="float-right">
                <a href="#">SISTEMAS-ALDIDACOM</a> &copy; 2022
            </span>
          </div>
        </footer>
        <!-- partial -->
