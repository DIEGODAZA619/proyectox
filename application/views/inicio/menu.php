            ...
            <ul class="nav">
                ...
                <?php foreach($roles as $rol): ?>
                    <?php if($rol->nivel== 1){ ?>
                        ...
                        <?php }?>
                        <li class="nav-item">
                        <a class="nav-link" data-toggle="collapse" href="#submenu<?php echo $rol->opcion; ?>" aria-expanded="false" aria-controls="collapseExample">
                            <i class="mdi mdi-chart-donut"></i>
                            <span class="menu-title"><?=$rol->opcion?></span>
                            <i class="mdi mdi-chevron-down"></i>
                        </a>
                        <div class="collapse" id="submenu<?php echo $rol->opcion; ?>">
