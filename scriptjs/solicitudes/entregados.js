...
function cargarTablaEntregados()
{
    var enlace = base_url + "Solicitudes/Reporte_entregas/cargartablaSolicitadesEntregadas";
    $('#idTablaMaterialesEntregados').DataTable({
        destroy: true,
...
function reporteEntregados(idConfirmacion)
{
    $('#txtIdSolicitudDireccion').val(idConfirmacion);
    $('#btnAutorizar').show();
    var enlace = base_url + "Solicitudes/Reporte_entregas/cargarTablasolicitudesIdConfirmacion";
